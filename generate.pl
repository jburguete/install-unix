...
if ($os eq "Linux")
{
    ...
    elsif ($dist eq "openSUSE")
    {
        ...
        @packages = (
                     ...
                     "glib2-devel",        "gettext-tools",
                     "json-glib-devel",    "sqlite3-devel",
                     "gsl-devel",          "libgtop-devel",
                     "gtk3-devel",         "gtk4-devel",
                     "libglfw-devel",      "SDL2-devel",
                     "SDL3-devel",         "gnu-free-fonts",
                     "glew-devel",         "vulkan",
    ...
    elsif ($dist eq "Alpine")
    {
        ...
        @packages = (
                     ...
                     "glib-dev",         "json-glib-dev",
                     "gsl-dev",          "libgtop-dev",
                     "gtk+3.0-dev",      "gtk4.0-dev",
                     "glfw-dev",         "sdl2-dev",
                     "sdl3-dev",         "font-freefont",
                     "glew-dev",         "glslang",
                     "openmpi-dev",      "gvim",
                     "indent",           "perl-tidy",
                     "gnuplot",          "galculator",
                     "valgrind",         "gdb",
                     "meld",             "texlive-most",
                     "texlive-binextra", "graphviz",
                     "doxygen",          "ublock-origin",
...
elsif ($os eq "SunOS")
{
    ...
    @packages = (
                 ...
                 "autoconf",              "autoconf-archive",
                 "automake",              "pkg-config",
                 "gcc-14",                "developer/clang-19",
                 "developer/build/meson", "ninja",
