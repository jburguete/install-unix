...
if ( $os eq "Linux" ) {
    ...
    if ( $dist eq "Debian" || $dist eq "Devuan" ) {
        ...
        @packages = (
            ...
            "evince",                    "doxygen",
            "wget",                      "firefox",
            "firefox-locale-es",         "webext-ublock-origin-firefox",
        ...
        @upgrade = (
            ...
            "system-upgrade", "download", "--release=41;", "dnf",
        ...
        @clean      = (
            "emerge",      "--ask",  "--depclean", ";",
            "eclean-dist", "--deep", ";",          "eclean-kernel",
            "-n",          "2"
        );
        @update  = ( "emerge", "--sync" );
        @upgrade = (
...
"PKG_PATH=\"http://cdn.NetBSD.org/pub/pkgsrc/packages/$os/$arch/$ver/All\"\nPATH=\"/usr/pkg/sbin:\$PATH\"\nexport PATH PKG_PATH"
    ...
    @packages = (
        ...
        "tex-babel-english",              "texlive-collection-english",
        "texlive-collection-langspanish", "texlive-collection-langfrench",
        "graphviz",                       "tex-latexdiff",
        "evince",                         "doxygen",
        "wget",                           "firefox-esr",
...
"/bin/bash -c \"\$(curl -fsSL https://raw.githubusercontent.com/Homebrew/install/master/install.sh)\""
    ...
    @packages   = (
        ...
        "pkgconf",    "gcc",           "llvm",           "make",
        "git",        "subversion",    "libxml2",        "gettext",
        "glib",       "json-glib",     "sqlite",         "gsl",
        "libgtop",    "gtk+3",         "gtk4",           "freeglut",
        "glfw",       "sdl2",          "glew",           "glslang",
        "mpich",      "font-freefont", "font-open-sans", "nedit",
        "gnu-indent", "perltidy",      "maxima",         "ddd",
        "graphviz",   "texlive",       "latexdiff",      "evince",
